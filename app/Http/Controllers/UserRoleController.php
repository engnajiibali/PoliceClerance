...
$userRole = user_roles::paginate(10);
return view('userRole.index',compact('userRole','pageTitle','subTitle'));
}
...
return view('userRole.add',compact('menus','submenus','pageTitle','subTitle'));
...
$existingRole = user_roles::where('Role', $request->Role)->first();
...
$menus = Menu::all();
$submenus = SubMenu::with('menu')->get();
$role = user_roles::findOrfail($id);
// return [$menus, $submenus];
    $pageTitle ="User Management";
     $subTitle ="Edit User Role";

return view('userRole.edit',compact('menus','submenus','role','pageTitle','subTitle'));
}
...
$role = user_roles::where('Role', $request->Role)->first();
