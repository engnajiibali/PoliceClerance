                        ...
                        <div class="card card-bg-1">
                            <div class="card-body p-0">
                                <span class="avatar avatar-xl avatar-rounded border border-2 border-white m-auto d-flex mb-2">
                                    <img src="<?php echo e(asset('public/upload/personImg/' .$person->image)); ?>" class="w-auto h-auto" alt="Img">
                                </span>
                                <div class="text-center px-3 pb-3 border-bottom">
                                    <div class="mb-3">
                                        <h5 class="d-flex align-items-center justify-content-center mb-1"><?php echo e($person->FullName); ?><i class="ti ti-discount-check-filled text-success ms-1"></i></h5>
                                       <!--  <span class="badge badge-soft-dark fw-medium me-2">
                                            <i class="ti ti-point-filled me-1"></i><?php echo e($person->Gender); ?>

                                        </span> -->
                                        <span class="badge badge-soft-secondary fw-medium">Member since <?php echo e(\Carbon\Carbon::parse($person->created_at)->format(' M Y')); ?></span>
                                    </div>
                                    <div>
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <p class="text-dark">EMP-<?php echo e(str_pad($person->id, 4, '0', STR_PAD_LEFT)); ?></p>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <p class="text-dark"><?php echo e(\Carbon\Carbon::parse($person->created_at)->format('d M Y')); ?></p>
                                        </div>                                   
                                        <div class="row gx-2 mt-3">
                                            <div class="col-6">
                                                <div>
                                                    <a href="#" class="btn btn-dark w-100" data-bs-toggle="modal" data-bs-target="#edit_person"><i class="ti ti-edit me-1"></i>Edit Info</a>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div>
                                ...
                                <div class="p-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <p class="text-dark"><?php echo e(showMobileNumber($person->Phone)); ?></p>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <span class="d-inline-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="text-info d-inline-flex align-items-center"><?php echo e(showMobileNumber($person->Email)); ?><i class="ti ti-copy text-dark ms-2"></i></a>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <span class="d-inline-flex align-items-center">
                                        ...
                                        <p class="text-dark text-end"><?php echo e($person->Gender); ?></p>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <p class="text-dark text-end">Maka almukarama Road, <br> Mogadishu,Somalia</p>
                                    </div>
                                </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <div class="d-flex align-items-center">
          ...
          <span>Person ID: #<?php echo e($person->id_no); ?></span>
        </div>
      ...
      <form id="pForm" method="post" action="<?php echo e(route('persons.update', $person->id)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
          ...
          <div class="col-md-12 mb-4">
            <div class="d-flex align-items-center flex-wrap bg-light rounded p-3">
              ...
              <div class="avatar avatar-xxl rounded-circle border border-dashed me-3 flex-shrink-0 d-flex justify-content-center align-items-center">
                <img src="<?php echo e(asset('public/upload/personImg/' .$person->image)); ?>" alt="Profile Image" class="rounded-circle" style="max-width: 120px; max-height: 120px;">
              </div>
              ...
              <div class="profile-upload">
                ...
                <div class="d-flex align-items-center">
                  <label class="btn btn-sm btn-primary me-2 mb-0" for="personImgInput" style="cursor:pointer;">
                    Upload
                    <input type="file" id="personImgInput" name="personImg" class="form-control d-none">
                  </label>
                  <button type="button" class="btn btn-light btn-sm">Cancel</button>
                </div>

                <span class="text-danger"><?php $__errorArgs = ['personImg'];
...
unset($__errorArgs, $__bag); ?></span>
          ...
          <div class="col-sm-6 mb-3">
            ...
            <input class="form-control" type="text" id="fullName" name="fullName" placeholder="Full Name" value="<?php echo e(old('fullName', $person->FullName)); ?>">
          ...
          <div class="col-sm-6 mb-3">
            ...
            <div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender" id="genderMale" value="Male" <?php echo e(old('gender', $person->Gender) == 'Male' ? 'checked' : ''); ?>>
                <label class="form-check-label" for="genderMale">Male</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender" id="genderFemale" value="Female" <?php echo e(old('gender', $person->Gender) == 'Female' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?></span>
          ...
          <div class="col-sm-6 mb-3">
            ...
            <input class="form-control" type="email" id="email" name="email" placeholder="email@example.com" value="<?php echo e(old('email', $person->Email)); ?>">
...
unset($__errorArgs, $__bag); ?></span>
          ...
          <div class="col-sm-6 mb-3">
            ...
            <input class="form-control" type="text" id="phone" name="phone" placeholder="+252 xxxxxxxxx" value="<?php echo e(old('phone', $person->Phone)); ?>">
...
unset($__errorArgs, $__bag); ?></span>
        ...
        <div class="modal-footer">
          <a href="<?php echo e(route('persons.index')); ?>" class="btn btn-outline-light border me-3">Cancel</a>
...
<?php echo $__env->make('include.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\policeclerance\resources\views/persons/show.blade.php ENDPATH**/ ?>