    ...
    <div class="card mb-3">
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('crimes-cases.index')); ?>" class="btn btn-secondary">
                    <i class="ti ti-arrow-big-left me-2"></i> Back
                </a>
                <a href="<?php echo e(route('crimes-cases.create')); ?>" class="btn btn-primary">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item py-3 <?php echo e(request()->routeIs('crimes-cases.show') ? 'active bg-primary text-white' : ''); ?>">
                            <a href="<?php echo e(route('crimes-cases.show', $crimecase->id)); ?>" class="d-flex align-items-center <?php echo e(request()->routeIs('crimes-cases.show') ? 'text-white' : 'text-dark'); ?>">
                                <i class="flaticon-file-2 me-2"></i> <span>Faahfaahin</span>
                            </a>
                        </li>

                        <li class="list-group-item py-3 <?php echo e(request()->routeIs('crimes-cases.suspects') ? 'active bg-primary text-white' : ''); ?>">
                            <a href="<?php echo e(route('crimes-cases.suspects', $crimecase->id)); ?>" class="d-flex align-items-center <?php echo e(request()->routeIs('crimes-cases.suspects') ? 'text-white' : 'text-dark'); ?>">
                                <i class="flaticon-users me-2"></i> <span>Eedeysanayaal</span>
                            </a>
                        </li>

                        <li class="list-group-item py-3 <?php echo e(request()->routeIs('crimes-cases.victims') ? 'active bg-primary text-white' : ''); ?>">
                            <a href="<?php echo e(route('crimes-cases.victims', $crimecase->id)); ?>" class="d-flex align-items-center <?php echo e(request()->routeIs('crimes-cases.victims') ? 'text-white' : 'text-dark'); ?>">
                                <i class="flaticon-users me-2"></i> <span>Dhibanayaal</span>
                            </a>
                        </li>

                        <li class="list-group-item py-3 <?php echo e(request()->routeIs('crimes-cases.witnesses') ? 'active bg-primary text-white' : ''); ?>">
                            <a href="<?php echo e(route('crimes-cases.witnesses', $crimecase->id)); ?>" class="d-flex align-items-center <?php echo e(request()->routeIs('crimes-cases.witnesses') ? 'text-white' : 'text-dark'); ?>">
                                <i class="flaticon-eye me-2"></i> <span>Goobjoogayaal</span>
                            </a>
                        </li>

                        <li class="list-group-item py-3 <?php echo e(request()->routeIs('crimes-cases.evidence') ? 'active bg-primary text-white' : ''); ?>">
                            <a href="<?php echo e(route('crimes-cases.evidence', $crimecase->id)); ?>" class="d-flex align-items-center <?php echo e(request()->routeIs('crimes-cases.evidence') ? 'text-white' : 'text-dark'); ?>">
        ...
        <div class="col-lg-9">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <?php echo $__env->yieldContent('case-content'); ?>
...
if (matchResult.MatchingScore >= idQuality) {
    scannedUrl = "<?php echo e(route('getdata.show', ':id')); ?>".replace(':id', person.person_id);
...
let imageUrl = data.person.image 
    ? `<?php echo e(asset('upload/personImg/')); ?>/${data.person.image}` 
    : `<?php echo e(asset('images/default-avatar.png')); ?>`;
            ...
            `;
const basePath = "<?php echo e(asset('../../../')); ?>/";
...
<?php echo $__env->make('include.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\policeclerance\resources\views/crimecases/layout.blade.php ENDPATH**/ ?>