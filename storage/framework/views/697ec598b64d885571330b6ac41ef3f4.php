...
<a class="nav-link" href="custom-css.html"><i class="ti ti-settings-2 me-2"></i>Crimes</a>
    ...
    <img src="<?php echo e($applicant->photo_path 
         ...
         data-bs-target="#imageModal">
                    ...
                    <div class="text-center px-3 pb-3 border-bottom">
                        <div class="mb-3">
                            <h5 class="d-flex align-items-center justify-content-center mb-1">
                              <?php echo e($applicant->first_name . ' ' . $applicant->middle_name 
                            ...
                            <span class="badge badge-soft-secondary fw-medium">
                                Member since <?php echo e(date('M Y', strtotime($applicant->created_at))); ?>
                        ...
                        <div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <p class="text-dark"><?php echo e($applicant->id ?? 'N/A'); ?></p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="d-inline-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <p class="text-dark">
                                    <?php echo e($applicant->dob ? date('d M Y', strtotime($applicant->dob)) : 'N/A'); ?>
                                ...
                                <p class="text-dark">
                                   <?php echo e($applicant->marital_status ?? 'N/A'); ?>
                    ...
                    <div class="p-3 border-bottom">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <p class="text-dark"><?php echo e($applicant->phone ?? '***'); ?></p>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <a href="javascript:void(0);" class="text-info d-inline-flex align-items-center">
                                <?php echo e($applicant->email ?? 'N/A'); ?>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <p class="text-dark text-end"><?php echo e($applicant->gender ?? 'N/A'); ?></p>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <p class="text-dark text-end"><?php echo e($applicant->address ?? 'Address not available'); ?></p>
                        </div>
                    </div>
                     <!-- <div class="p-3 border-bottom">
                        <div class="d-flex align-items-center  text-white justify-content-between mb-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <p class="text-dark"><?php echo e($applicant->color ?? '***'); ?></p>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <p class="text-dark text-end"><?php echo e($applicant->blood ?? 'N/A'); ?></p>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <p class="text-dark text-end"><?php echo e($applicant->height ?? 'N/A'); ?></p>
                        </div>
                    </div> -->
                </div>
            </div>
...
<div class="card-body">
    ...
    <div class="row text-center">
        <?php if($LeftHand->count() > 0): ?>
            <?php $__currentLoopData = $LeftHand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $finger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-4">
                    
                    <small class="d-block mb-2"><?php echo e(strtoupper(str_replace('_', ' ', $finger->finger_name))); ?></small>

                    
                    <?php if($finger->finger_img && file_exists(public_path($finger->finger_img))): ?>
                        <img src="<?php echo e(asset($finger->finger_img)); ?>" 
    ...
    <div class="row text-center">
        <?php if($RightHand->count() > 0): ?>
            <?php $__currentLoopData = $RightHand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $finger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-4">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="d-flex align-items-center">
                    ...
                    <span>applicant ID: #<?php echo e($applicant->id_no); ?></span>
                </div>
            ...
            <form id="pForm" method="post" action="<?php echo e(route('applicants.update', $applicant->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="d-flex align-items-center flex-wrap bg-light rounded p-3">
                            <div class="avatar avatar-xxl rounded-circle border border-dashed me-3 flex-shrink-0 d-flex justify-content-center align-items-center">
                                <img src="<?php echo e($applicant->picture 
                            ...
                            <div class="profile-upload">
                                ...
                                <span class="text-danger"><?php $__errorArgs = ['applicantImg'];
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <input class="form-control" type="text" id="fullName" name="fullName" placeholder="Full Name" value="<?php echo e(old('fullName', $applicant->FullName)); ?>">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gender" id="genderMale" value="Male" <?php echo e(old('gender', $applicant->Gender) == 'Male' ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="genderMale">Male</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gender" id="genderFemale" value="Female" <?php echo e(old('gender', $applicant->Gender) == 'Female' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <input class="form-control" type="email" id="email" name="email" placeholder="email@example.com" value="<?php echo e(old('email', $applicant->Email)); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <input class="form-control" type="text" id="phone" name="phone" placeholder="+252 xxxxxxxxx" value="<?php echo e(old('phone', $applicant->Phone)); ?>">
...
<script>
    ...
    document.getElementById('cancelUpload').addEventListener('click', function() {
        ...
        document.getElementById('profileImagePreview').src = "<?php echo e($applicant->picture 
                ? asset('https://spf-hr.com/media/'.$applicant->picture) 
                : asset('upload/applicantImg/male.jpeg')); ?>";
    });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\policeclerance\resources\views/applicants/show.blade.php ENDPATH**/ ?>