...
<div class="card border shadow-sm">
    <div class="card-header bg-primary text-white fw-bold d-flex justify-content-between align-items-center">
        <span><i class="ti ti-users me-2"></i> Suspects for Case #<?php echo e($crimecase->case_number); ?></span>
    </div>

    <div class="card-body">

        
        <form action="<?php echo e(route('crimes-cases.suspects.store', $crimecase->id)); ?>" method="POST" class="row mb-4">
            <?php echo csrf_field(); ?>
    ...
    <div class="flex-grow-1">
        ...
        <select name="person_id" id="person_id" class="form-select select2" required>
            ...
            <?php $__currentLoopData = $persons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($person->id); ?>"><?php echo e($person->FullName); ?></option>
                            ...
                            <tr>
                                ...
                                <td>
											<div class="action-icon d-inline-flex">
												<a href="#" class="me-2  view-suspect"  data-id="<?php echo e($suspect->id); ?>" 
...
<div class="modal fade" id="add_person" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <form action="<?php echo e(route('suspect.store123')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">                                                
                               ...
                               <input type="hidden" name="crimecase_id" value="<?php echo e($crimecase->id); ?>">
...
$(document).ready(function() {
    $('.view-suspect').click(function() {
        ...
        let url = "<?php echo e(route('suspects.View', ':id')); ?>".replace(':id', suspectId);

        $('#suspect-details').html('<p class="text-muted">Loading...</p>');

      $.get(url, function(data) {
let imageUrl = data.image 
    ? `<?php echo e(asset('upload/personImg/')); ?>/${data.image}` 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('crimecases.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\policeclerance\resources\views/crimecases/suspects.blade.php ENDPATH**/ ?>