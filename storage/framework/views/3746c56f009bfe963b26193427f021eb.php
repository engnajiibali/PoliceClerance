...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
            <div class="input-icon mb-2 position-relative">
                ...
                <div id="currentDateTime" class="form-control bg-light text-dark fw-bold" style="pointer-events: none;">
                    <!-- JavaScript will insert the date/time here -->
                </div>
            </div>
    ...
    <div class="welcome-wrap mb-4">
        <div class=" d-flex align-items-center justify-content-between flex-wrap">
            <div class="mb-3">
                <h2 class="mb-1 text-white">Welcome Back, <?php echo e(Session()->get('username')); ?></h2>
        ...
        <div class="welcome-bg">
            <img src="<?php echo e(asset('assets/img/bg/welcome-bg-02.svg')); ?>" alt="img" class="welcome-bg-01">
            <img src="<?php echo e(asset('assets/img/bg/welcome-bg-03.svg')); ?>" alt="img" class="welcome-bg-02">
            <img src="<?php echo e(asset('assets/img/bg/welcome-bg-01.svg')); ?>" alt="img" class="welcome-bg-03">
        </div>
    </div>  
    <!-- /Welcome Wrap -->
...
backgroundColor: ['#36A2EB', '#FF6384'],  // Blue and Pink
hoverOffset: 30
}]
},
options: {
...
<?php echo $__env->make('include.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gmpf\resources\views/dashboard/index.blade.php ENDPATH**/ ?>