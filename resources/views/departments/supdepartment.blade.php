				...
				<div class="card-body p-0">
					<div class="custom-datatable-filter table-responsive">
						<table class="table">
							...
							<tbody>
								<?php $i = 1; ?>
								@forelse ($supdepartments as $department)
								<tr>
									<td>{{ $i }}</td>
				...
				<div class="card-body">
					...
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Add Sup Department</h4>
						</div>
						<hr>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="mb-3">
											...
											<div class="col-md-12">
										<div class="mb-3">
											<label class="form-label">Department <strong class="text-danger">*</strong></label>
