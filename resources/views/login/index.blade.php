          ...
          <div class="col-lg-5">
            <div class="login-background position-relative d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100">
              <div class="bg-overlay-img">
                <img src="{{ asset('assets/img/bg/1750581276.1747930132imgimages-Photoroom.png') }}" class="bg-1" alt="Img">
                <img src="{{ asset('assets/img/bg/1750581276.1747930132imgimages-Photoroom.png') }}" class="bg-2" alt="Img">
                ...
                <form id="pForm" method="post" action="{{ route('login-user') }}" enctype="multipart/form-data" class="vh-100">
                  ...
                  <div class="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
                    <div class="mx-auto mb-5 text-center">
                      <img src="{{ asset('upload/logo/1750581276.1747930132imgimages-Photoroom.png') }}" class="img-fluid" alt="Logo" style="width: 150px; height: auto;">
                    </div>
                    ...
                    <div class="mt-5 pb-4 text-center">
                      <p class="mb-0 text-gray-9">&copy; {{ now()->year }} - Hubaal Technology Solutions</p>
                    </div>
                  </div>
                </form>
              </div>
