...
<head>
   ...
   <!-- Favicon -->
   <link rel="shortcut icon" type="image/x-icon" href="{{ asset('upload/logo/') }}">

   <!-- Apple Touch Icon -->
   <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('upload/logo/') }}">
         ...
         <div class="main-header">
            ...
            <div class="header-left">
               <a href="{{asset('dashboard/')}}" class="logo">
                  <img src="{{ asset('upload/logo/'.getSiteLogo()) }}" alt="Logo">
               </a>
            ...
            <div class="dropdown profile-dropdown">
               <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                  <span class="avatar avatar-sm online">
                     <img src="{{asset('upload/'.Session()->get('photo'))}}" alt="Img" class="img-fluid rounded-circle">
                  </span>
               </a>
                     ...
                     <div class="card-header">
                        <div class="d-flex align-items-center">
                           <span class="avatar avatar-lg me-2 avatar-rounded">
                              <img src="{{asset('upload/'.Session()->get('photo'))}}" alt="img">
                           </span>
                           <div>
               ...
               <div class="card-footer py-1">
                  <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" href="{{asset('/logOut')}}"><i class="ti ti-login me-2"></i>Logout</a>
               </div>
            </div>
         </div>
      </div>
...
<div class="sidebar" id="sidebar">
   ...
   <div class="sidebar-logo">
      <a href="{{asset('dashboard/')}}" class="logo logo-normal">
         <img src="{{ asset('upload/logo/'.getSiteLogo()) }}" alt="Logo1" width="200" height="100">
      </a>
      <a href="{{asset('dashboard/')}}" class="logo-small">
         <img src="{{ asset('upload/logo/'.getSiteLogo()) }} " alt="Logo2">
      </a>
      <a href="{{asset('dashboard/')}}" class="dark-logo">
         <img src="{{ asset('upload/logo/'.getSiteLogo()) }} " alt="Logo3">
      </a>
   </div>
   <!-- /Logo -->
