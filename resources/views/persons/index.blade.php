...
<div class="mb-2">
<a href="{{asset('persons/create')}}"  class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Employee</a>
</div>
...
<td><a href="employee-details.html">EMP-{{ str_pad($person->id, 4, '0', STR_PAD_LEFT) }}</a></td>
<td>
<div class="d-flex align-items-center">
<a href="{{ route('persons.show', $person->id) }}" class="avatar avatar-md"><img
src="{{ asset('public/upload/personImg/'.$person->image) }}" class="img-fluid rounded-circle" alt="img"></a>
<div class="ms-2">
<p class="text-dark mb-0"><a href="{{ route('persons.show', $person->id) }}">{{ $person->FullName }}</a></p>
<span class="fs-12">
