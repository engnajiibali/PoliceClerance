                        ...
                        <div class="card card-bg-1">
                            <div class="card-body p-0">
                                <span class="avatar avatar-xl avatar-rounded border border-2 border-white m-auto d-flex mb-2">
                                    <img src="{{ asset('public/upload/personImg/' .$person->image) }}" class="w-auto h-auto" alt="Img">
                                </span>
                                <div class="text-center px-3 pb-3 border-bottom">
                                    <div class="mb-3">
                                        <h5 class="d-flex align-items-center justify-content-center mb-1">{{$person->FullName}}<i class="ti ti-discount-check-filled text-success ms-1"></i></h5>
                                       <!--  <span class="badge badge-soft-dark fw-medium me-2">
                                            <i class="ti ti-point-filled me-1"></i>{{$person->Gender}}
                                        </span> -->
                                        <span class="badge badge-soft-secondary fw-medium">Member since {{ \Carbon\Carbon::parse($person->created_at)->format(' M Y') }}</span>
                                    </div>
                                    <div>
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <p class="text-dark">EMP-{{ str_pad($person->id, 4, '0', STR_PAD_LEFT) }}</p>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <p class="text-dark">{{ \Carbon\Carbon::parse($person->created_at)->format('d M Y') }}</p>
                                        </div>                                   
                                ...
                                <div class="p-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <p class="text-dark">{{showMobileNumber($person->Phone)}}</p>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <span class="d-inline-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="text-info d-inline-flex align-items-center">{{showMobileNumber($person->Email)}}<i class="ti ti-copy text-dark ms-2"></i></a>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <span class="d-inline-flex align-items-center">
                                        ...
                                        <p class="text-dark text-end">{{$person->Gender}}</p>
                                    </div>
          ...
          <div class="col-md-12 mb-4">
            <div class="d-flex align-items-center flex-wrap bg-light rounded p-3">
              ...
              <div class="avatar avatar-xxl rounded-circle border border-dashed me-3 flex-shrink-0 d-flex justify-content-center align-items-center">
                <img src="{{ asset('public/upload/personImg/' .$person->image) }}" alt="Profile Image" class="rounded-circle" style="max-width: 120px; max-height: 120px;">
              </div>
